...
['fname']; ?>">
                        <p class="contact"><label for="cname">Vehicle Type</label></p> 
    						...
    						<p class="contact"><label for="cname">Auto Name</label></p> 
    						<input id="bname" name="name" placeholder="Auto Name" required  type="text"> 
...
<option>Viramgam</option>
                ...
                <p class="contact"><label for="email">Email Address</label></p> 
      			...
      			<div class="fl_right">
					<h1 align="center"></h1>
	  				<img src="images/bigauto.jpg" height="500" width="500"/>
				</div>
			</div>
			<div class="back">
