...
['fname']; ?>">
                        <p class="contact"><label for="cname">Vehicle Type</label></p> 
    						...
    						<p class="contact"><label for="cname">Car Name</label></p> 
    						<input id="bname" name="name" placeholder="Car Name" required  type="text"> 
...
<option>Viramgam</option>
      			...
      			<div class="fl_right">
					<h1 align="center"></h1>
	  				<img src="images/big_car.jpg" height="500" width="500"/>
				</div>
			</div>
			<div class="back">
