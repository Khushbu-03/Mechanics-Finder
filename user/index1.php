...
<head>
	...
	</script>									<!-- End Homepage Only Scripts -->
	<style>
		.pics 
		{  
	 		height: 393px;
...
<body id="top">
	...
	<div class="wrapper col2">
  		<div id="header" class="clear">
    		...
    		<div id="topnav">
      			<ul>
					<li class="last"><a href="fdn.php">Feedback</a></li>
        			<li><a href="csn.php">Contact us</a></li>
					...
					<li class="active"><a href="index1.php">Homepage</a></li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="wrapper col3">
		<div class="pics"> 
    		<img src="images/69610172.jpg"  /> 
    		<img src="images/a.jpg"  /> 
    		<img src="images/auto-repair.jpg"  /> 
			<img src="images/CarRepair.jpg" /> 
		</div> 
 	</div>
					<!-- ####################################################################################################### -->
	<div class="wrapper col4">
  		<div id="container" class="clear"> 
    		<div id="shout" class="clear">
      			<div class="fl_left">
        			<h2><a href="ems.php"> Emergency Mechanics Search</a></h2>
				</div>
    		</div>
    		<div id="homepage" class="clear">
      			<div class="fl_left">
        			<h2>Welcome</h2>
         			<p>Mechanics Finder is the web application is to find the mechanic if your vehicle becomes damaged then you can find the mechanic detail in your area from our website and if you dont know area then in our websites provides the application to directly find your location you are placed.</p>
